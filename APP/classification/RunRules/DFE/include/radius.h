 ...
 * 
 * \param [in] param_K Interface Parameter "K".
 * \param [in] param_N Interface Parameter "N".
 * \param [in] param_P Interface Parameter "P".
 * \param [in] param_R Interface Parameter "R".
 * \param [in] instream_a The stream should be of size ((param_N * param_K) * 4) bytes.
 * \param [out] outstream_c The stream should be of size ((param_P * param_K) * 4) bytes.
 ...
 */
typedef struct { 
	int64_t param_K; /**<  [in] Interface Parameter "K". */
	int64_t param_N; /**<  [in] Interface Parameter "N". */
	int64_t param_P; /**<  [in] Interface Parameter "P". */
	int64_t param_R; /**<  [in] Interface Parameter "R". */
	const float *instream_a; /**<  [in] The stream should be of size ((param_N * param_K) * 4) bytes. */
	float *outstream_c; /**<  [out] The stream should be of size ((param_P * param_K) * 4) bytes. */
